...
#include "AmmoEntity.h"  // NEW: Ammo object
...
public:
	...
	// NEW: Create an ammo pack, requires a health template name, may supply entity name and position
	// Returns the UID of the new entity
	TEntityUID CreateAmmoPack
	(
		const string&    templateName,
		const string&    name = "",
		const CVector3&  position = CVector3::kOrigin,
