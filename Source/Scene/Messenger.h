...
enum EMessageType
{
	Msg_Start, // Send a message to start moving
	Msg_Stop,  // Send a message to stop all actions
	Msg_Hit,    // Send a message saying tank has been hit by a bullet
	Msg_Evade, // Send a message telling the tank to automatically switch to the evade state
	          // (used when a user clicks on the tank with the mouse)
	Msg_HelpMe, // Send a message to allow the tank to call for help from other team mates
	Msg_NewHealthPack,   // Drop a new health pack
	Msg_HealthCollected, // A tank has collected a health pack
	Msg_NewAmmoPack,   // NEW: Drop a new ammo pack
	Msg_AmmoCollected, // NEW: A tank has collected an ammo pack
};
