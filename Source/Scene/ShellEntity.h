...
public:
	...
	(
		...
		TEntityUID       UID,
		const string&    name = "",
		TEntityUID       tankUID = 0, // Additional tank UID
...
private:
	...
	TFloat32 m_ShellLifeTime; // Time left for the bullets life (till it is destroyed)
	TFloat32 m_ShellSpeed;    // Speed of the bullet
	TEntityUID m_TankUID;     // The UID of tank that fired the bullet
};
